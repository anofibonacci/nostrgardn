...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<nav><a href="/" class="title svelte-1hvh50w"><b>${escape(title)}</b></a></nav> <h1 class="svelte-1hvh50w" data-svelte-h="svelte-1ucwr6"><i>California, USA</i></h1> <p class="svelte-1hvh50w" data-svelte-h="svelte-95h0wg">Digging holes, planting seeds, and watering so others may view our garden in a
