...
const css$4 = {
  code: "footer.svelte-gsrux1{padding-block:var(--size-7)}p.svelte-gsrux1{color:var(--text-2)}",
  map: null
};
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$4);
  return `<footer class="svelte-gsrux1"><center><p class="svelte-gsrux1">developed at <b>${escape(title)}</b> © ${escape((/* @__PURE__ */ new Date()).getFullYear())}</p></center> </footer>`;
});
...
const Flower = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Icon$1, "Icon").$$render($$result, Object.assign({}, { name: "flower" }, $$props, { iconNode }), {}, {
    default: () => {
...
const Leaf = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Icon$1, "Icon").$$render($$result, Object.assign({}, { name: "leaf" }, $$props, { iconNode }), {}, {
    default: () => {
      return `${slots.default ? slots.default({}) : ``}`;
    }
  })}`;
...
const css$3 = {
  code: "div.svelte-65lgqq.svelte-65lgqq{stroke-width:3px;size:13px}button.svelte-65lgqq.svelte-65lgqq{padding:0;font-weight:inherit;background:none;border:none;box-shadow:none;overflow:hidden}button.svelte-65lgqq>.svelte-65lgqq{display:flex;gap:var(--size-2)}",
  map: null
};
const Toggle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_theme();
  return `<button aria-label="Toggle theme" class="svelte-65lgqq">${$theme === "dark" ? `<div class="svelte-65lgqq">${validate_component(Flower$1, "Flower").$$render($$result, {}, {}, {})} </div>` : `<div class="svelte-65lgqq">${validate_component(Leaf$1, "Leaf").$$render($$result, {}, {}, {})} </div>`} </button>`;
});
const header_svelte_svelte_type_style_lang = "";
const css$2 = {
  code: "nav.svelte-e853hf{padding-block:var(--size-7)}@media(min-width: 768px){nav.svelte-e853hf{display:absolute;justify-content:space-between}}",
  map: null
};
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `<center><nav class="svelte-e853hf">${validate_component(Toggle, "Toggle").$$render($$result, {}, {}, {})}</nav> </center>`;
});
