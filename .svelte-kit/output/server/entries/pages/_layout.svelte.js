...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<footer class="svelte-rd2s5b"><center><p class="svelte-rd2s5b">developed at <b>${escape(title)}</b> © ${escape((/* @__PURE__ */ new Date()).getFullYear())}</p></center> </footer>`;
});
...
const Toggle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_theme();
  return `<button aria-label="Toggle theme" class="svelte-u3wayo">${$theme === "dark" ? `<div class="svelte-u3wayo">${validate_component(Flower$1, "Flower").$$render($$result, {}, {}, {})} </div>` : `<div class="svelte-u3wayo">${validate_component(Leaf$1, "Leaf").$$render($$result, {}, {}, {})} </div>`} </button>`;
});
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `<div class="layout svelte-3ah9f7">${validate_component(Header, "Header").$$render($$result, {}, {}, {})} <main class="svelte-3ah9f7">${validate_component(Transition, "PageTransition").$$render($$result, { url: data.url }, {}, {
    default: () => {
      return `${slots.default ? slots.default({}) : ``}`;
    }
