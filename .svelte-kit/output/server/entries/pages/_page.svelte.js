...
const PictureCard = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    return `${
      post.pubkey.substring(0, 9) == myNine
        ? `<div class="eventBlock svelte-zghf0h"><h5>${escape(
            myNine
          )}</h5> <h6 class="svelte-zghf0h">${escape(
            dayjs.unix(post.created_at ?? 0).format("MMM D, YYYY h:mm a")
          )}<br> </h6> <p><!-- HTML_TAG_START -->${convertLinkToImage(
            addLineBreaks(linkify(content))
          )}<!-- HTML_TAG_END --></p></div>`
        : `${
            post.tags
              ? `${each(Array.from(post.tags), (tag) => {
                  return `${
                    tag[0] == "r" && isImageLink(tag[1])
                      ? `<div class="image-container svelte-zghf0h"><img${add_attribute(
                          "src",
                          tag[1],
                          0
                        )} alt="${
                          "user: " + escape(post.pubkey, true)
                        }" class="svelte-zghf0h"> </div>`
                      : ``
                  }`;
                })}`
              : ``
  ...
  return `<section><nav class="svelte-1gqsokj" data-svelte-h="svelte-18bav37"><ul class="links svelte-1gqsokj"><li><a href="/about" class="svelte-1gqsokj">nostrgardn</a></li></ul></nav> <div class="image-container svelte-1gqsokj" data-svelte-h="svelte-1jv1zxw"><img src="IMG_8530.jpeg" alt="idk" class="svelte-1gqsokj"> <img src="IMG_8531.jpeg" alt="idk" class="svelte-1gqsokj"> <img src="IMG_8532.jpeg" alt="idk" class="svelte-1gqsokj"></div> <p data-svelte-h="svelte-9hmwf2"> </p> ${(function (
    ...
    return (function (events) {
      return ` ${each(Array.from(events), (post) => {
        return `${validate_component(PictureCard, "PictureCard").$$render(
          $$result,
          { post },
          {},
          {}
